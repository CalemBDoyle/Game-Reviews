@props(['title', 'year', 'description', 'genre', 'image']) 
...
<h4 class="text-gray-800 font-semibold mb-2" style="font-size: 2rem;">{{ $genre }}</h4> <!-- Subheading for description --> 
...
        <img src="{{ asset('images/' . $image) }}" alt="{{ $title }}" class="w-full max-w-xs h-auto object-cover"> <!-- Restrict image to max-w-xs (20rem) and ensure responsiveness --> 
