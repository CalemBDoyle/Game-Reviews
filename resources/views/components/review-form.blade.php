...
<form action="{{ $action }}" method="POST" enctype="multipart/form-data">
    ...
    {{-- Cancel Button: I would need a game object to return to the games show view, I don’t have it here --}}
    {{-- <button type="button" onclick="window.location='{{ route('games.show', $game->id) }}'" 
